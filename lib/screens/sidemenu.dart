    ...
    return Drawer(
      child: ListView(
        ...
        children: <Widget>[
          ...
          ListTile(title: Text("New Menu"), onTap: (){Navigator.pushNamed(context, "/mainMenu/createMenu");}),
          ListTile(title: Text("New Detail Menu"), onTap: (){Navigator.pushNamed(context, "/createDetailMenu");})
        ]
      )
    );
  }
